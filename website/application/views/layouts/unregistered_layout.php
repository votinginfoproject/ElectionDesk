...
<body id="<?php echo $body_id; ?>">
	...
	<nav class="welcome-container">
		<section class="inner welcome-info">
		
		<h1>Welcome to ElectionDesk!</h1>
		<h2>MONITOR &bull; ENGAGE &bull; DISSEMINATE</h2>
		<p class="partners"><em>Brought to you by The Voting Information Project</em></p>
		</section>
	</nav>
